				...
				<div class="container-fluid">
                    <div class="panel panel-headline">
						<div class="panel-heading">
							<h4 class="panel-title">Data Restoran</h4>
						</div>
						<div class="container-fluid">
							<a href="tambah_data.php"><button class="btn btn-primary"><div class="fa fa-plus-square"></div> Tambah Data Restoran</button></a>
						</div>
                            ...
                            <table id="datatables" class="display" cellspacing="0">
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td><img src='images/<?php echo $data['foto'];?>' width='60' height='60'> </td> 

                                        <td>
                                        <a href="edit_data.php?<?php echo 'edit=' .$data['id_resto'] ?>"> <button class="btn btn-warning"> Edit</button> </a>
                                        <a href="hapus_data.php?<?php echo 'hapus=' .$data['id_resto'] ?>"> <button class="btn btn-danger"> Hapus</button> </a>
                                        </td>
                                    </tr>
